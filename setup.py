...
MODULE = 'purchase_create_shipment'
PREFIX = 'nantic'
MODULE2PREFIX = {}
OWNER = {
    'nantic':'NaN-tic',
...
setup(name='%s_%s' % (PREFIX, MODULE),
    ...
    url='https://github.com/NaN-tic/trytond-purchase_create_shipment',
    download_url='https://github.com:nantic/trytond-purchase_create_shipment.git',
    ...
    project_urls = {
       "Source Code": 'https://github.com:NaN-tic/trytond-purchase_create_shipment.git'
    },
    classifiers=[
